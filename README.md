...
исследования. Правки копятся в вашем профиле и уходят в архивы игры одной
кнопкой — с откатом к исходным архивам в любой момент.
...
`RolRulesEditor.App.exe`. Установка не нужна, в системе ничего не прописывается,
удаление — это удаление папки.
...
- здания, технологии и крафты открываются только на просмотр — их карточки
  пока недоступны для правки;
