...
«Исследованиях» так же правятся ветки развития лидера. У числового поля с
небольшим разбросом значений рядом с полем ввода появляется ползунок; там,
где разброс велик (например, у здоровья), шкала ничего бы не показала, и
ползунка нет.
...
- смена темы оформления частичная: часть подписей остаётся приглушённой до
  перезапуска редактора — так же говорит страница настроек.

Что менялось от версии к версии — в [журнале версий](CHANGELOG.md).
